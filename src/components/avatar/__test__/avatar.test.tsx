...
describe('test Avatar component', () => {
  ...
  it('should correct loading', () => {
    ...
    cleanup()
    wrapper = render(<Avatar data-testid="avatar-div" isLoading username="123" src="/" size="tiny"></Avatar>)
    svg = wrapper.getByTestId('avatar-div')
    expect(svg).toBeVisible()
  })
  it('should correct img', () => {
    let wrapper = render(<Avatar data-testid="avatar-img" src="www.test.com"></Avatar>)
    ...
    cleanup()
    wrapper = render(<Avatar data-testid="avatar-img" src="www.yehuozhili.xyz" username="yehuozhili"></Avatar>)
  ...
  it('should render correct username', () => {
    ...
    cleanup()
    wrapper = render(<Avatar data-testid="avatar-div" username="中文汉字"></Avatar>)
